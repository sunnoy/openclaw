...
export const DEFAULT_SANDBOX_BROWSER_START_POLICY = "lazy";
export const DEFAULT_SANDBOX_BROWSER_IDLE_STOP_AFTER_MS = 30 * 60 * 1000;
export const DEFAULT_SANDBOX_BROWSER_REMOVE_STOPPED_AFTER_MS = 7 * 24 * 60 * 60 * 1000;
export const DEFAULT_SANDBOX_BROWSER_STATE_RETAIN_AFTER_MS = 30 * 24 * 60 * 60 * 1000;
export const DEFAULT_SANDBOX_BROWSER_STATE_ROOT = path.join(STATE_DIR, "browser-state");
