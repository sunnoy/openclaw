...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.sandbox.browser.startPolicy": "Sandbox Browser Start Policy",
  "agents.defaults.sandbox.browser.idleStopAfter": "Sandbox Browser Idle Stop After",
  "agents.defaults.sandbox.browser.removeStoppedAfter": "Sandbox Browser Remove Stopped After",
  "agents.defaults.sandbox.browser.state.enabled": "Sandbox Browser Persistent State Enabled",
  "agents.defaults.sandbox.browser.state.root": "Sandbox Browser State Root",
  "agents.defaults.sandbox.browser.state.retainAfter": "Sandbox Browser State Retention",
  ...
  "agents.list.*.sandbox.browser.startPolicy": "Sandbox Browser Start Policy",
  "agents.list.*.sandbox.browser.idleStopAfter": "Sandbox Browser Idle Stop After",
  "agents.list.*.sandbox.browser.removeStoppedAfter": "Sandbox Browser Remove Stopped After",
  "agents.list.*.sandbox.browser.state.enabled": "Sandbox Browser Persistent State Enabled",
  "agents.list.*.sandbox.browser.state.root": "Sandbox Browser State Root",
  "agents.list.*.sandbox.browser.state.retainAfter": "Sandbox Browser State Retention",
  "agents.list.*.sandbox.browser.network": "Sandbox Browser Network",
  "agents.list.*.sandbox.browser.cdpSourceRange": "Sandbox Browser CDP Source Port Range",
